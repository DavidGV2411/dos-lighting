...
from app.fallback_assistant import FallbackAssistant
...
from app.session_store import ChatSession, SessionMetadata, SessionStore
from app.tools import ToolContextUpdate, ToolRunner
...
class ChatService:
    def __init__(
        self,
        *,
        openai_client: ModelClientProtocol | None,
